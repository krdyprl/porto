// Teks UI tetap (bukan data pribadi). Data pribadi ada di src/data/portfolio.js.
export const dictionary = {
  id: {
    ...
    contact: {
      title: "Kontak",
      subtitle: "Mari terhubung — saya senang berbincang soal proyek atau peluang.",
    },
    footer: {
      builtWith: "Dibuat dengan",
      using: "menggunakan Next.js",
    },
  },
  en: {
    nav: {
    ...
    contact: {
      title: "Contact",
      subtitle: "Let's connect — I'm happy to chat about projects or opportunities.",
    },
    footer: {
